...
Note:
    ...
    if target unit is F_INCH (Fahrenheit, inches) - input data should be in Celsius an millimeters
...
def celsius_to_fahrenheit(value: float) -> float:
    ...
    :param value: value Celsius degrees to be converted
    :type value: float
    :return: value in Fahrenheit degrees
    :rtype: float
    """
...
def fahrenheit_to_celsius(value: float) -> float:
    ...
    :param value: value Fahrenheit degrees to be converted
    :type value: float
...
def mm_to_inch(value: float) -> float:
    ...
    :param value: value in mm to be converted
    :type value: float
...
def inch_to_mm(value: float) -> float:
    ...
    :param value: value in inches to be converted
    :type value: float
...
def convert_to_c_mm(t: pd.DataFrame, p: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    :param t: pandas data frame with temperature from input data
    :type t: pandas.DataFrame
    :param p: pandas data frame with precipitation from input data
    :type p: pandas.DataFrame
    :return: two elements tuple (data frame temperature, data frame precipitation) with converted values
    :rtype: tuple
    """
...
def get_conversion_function(target_unit: str) -> Callable:
    ...
    """
    if target_unit == "C_MM":
        return convert_to_c_mm
    if target_unit == "F_INCH":
        return convert_to_f_inch

    raise ValueError(f"Not supported target unit: {target_unit}")
...
def main(
    ...
    """Convert climate data to target unit.
