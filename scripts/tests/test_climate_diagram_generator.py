...
def test_round_down():
    assert round_down(41.1, 1) == 41
    assert round_down(41.1, 10) == 40
    assert round_down(41.1, 100) == 0
    assert round_down(371.1, 100) == 300
    assert round_down(-2.1, 1) == -3
    assert round_down(-2.1, 5) == -5


def test_round_up():
    assert round_up(41.1, 1) == 42
    assert round_up(41.1, 10) == 50
    assert round_up(41.1, 100) == 100
